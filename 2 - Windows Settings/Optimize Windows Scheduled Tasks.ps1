...
function Set-ConsoleBackground {
    $Host.UI.RawUI.WindowTitle = "Optimize Windows Scheduled Tasks | IBRPRIDE"
...
function Optimize-ScheduledTasks {
    Write-Host "- Optimizing Windows Scheduled Tasks" -ForegroundColor Yellow
    ...
    # Disable Power Efficiency Diagnostics scheduled task
    schtasks /change /disable /tn "\Microsoft\Windows\Power Efficiency Diagnostics\AnalyzeSystem" 2> $null
    ...
    Write-Host "Scheduled tasks optimized successfully." -ForegroundColor Green
